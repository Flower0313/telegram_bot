...
/**
 * @ClassName telegram_bot-Constant
 * @Author Holden_—__——___———____————_____Xiao
 * @Create 2023年5月18日16:36 - 周四
 * @Describe
 */
public class Constant {
     ...
     * 机器人姓名
     */
    public static final String BOT_USERNAME = "flowergirlsbot";
    ...
    public static final int PHOENIX_LIST = 1003;

    /**
     * 未兑换前的菜单
     */
    public static final int SINGLE_PHOENIX = 1004;
    /**
     * 兑换后显示的菜单
     */
    public static final int AFTER_BUY = 1005;
